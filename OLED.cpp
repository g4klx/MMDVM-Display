...
void COLED::writeDStarInt(const std::string& my1, const std::string& my2, const std::string& your, const std::string& type, const std::string& reflector)
{
	m_mode = MODE_DSTAR;
	...
	m_display.printf("%s %.8s/%4.4s", type.c_str(), my1.c_str(), my2.c_str());

	m_display.setCursor(0, OLED_LINE4);
	m_display.printf("-> %.8s", your.c_str());

	m_display.setCursor(0, OLED_LINE5);
	m_display.printf("via %.8s", reflector.c_str());
...
void COLED::writeFusionInt(const std::string& source, const std::string& dest, unsigned char dgid, const std::string& type, const std::string& origin)
{
	m_mode = MODE_YSF;
	...
	m_display.setCursor(0, OLED_LINE4);
	m_display.printf("%s %.10s", type.c_str(), source.c_str());
...
void COLED::writeP25Int(const std::string& source, bool group, unsigned int dest, const std::string& type)
{
	m_mode = MODE_P25;
...
void COLED::writeNXDNInt(const std::string& source, bool group, unsigned int dest, const std::string& type)
{
	m_mode = MODE_NXDN;
